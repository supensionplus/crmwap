            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Nuevo Vendedor!</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="all-reseller.php">Todos los Vendedores</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                            ...
                            <div class="card-body">
                                <form id="reseller">
                                    ...
                                    <div class="form-actions">
                                        <div class="text-end">
                                            <button type="button" id="add-reseller" class="btn btn-info">Agregar Vendedor</button>
                                        </div>
                                    </div>
                                </form>
