      ...
      <div class="page-breadcrumb">
        <div class="row">
          <div class="col-7 align-self-center">
            <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Todos los Administradores!</h3>
          ...
          <div class="col-5 align-self-center">
            <div class="customize-input float-end">
              <a href="add-admin.php" class="custom-select-set form-control bg-white border-0 custom-shadow custom-radius">New <i class=" fas fa-plus"></i></a>
            </div>
          </div>
        </div>
      </div>
                ...
                <div class="table-responsive">
                  <table id="zero_config" class="table border table-striped table-bordered text-nowrap">
                    ...
                    <tbody>
                      <?php
                      $iduser = 0;
                      $q = mysqli_query($conn, "SELECT `id`,`username`, `name`, `contact_number`, `password`, `user_type`,`start_date`, `expired_date`, `status` FROM `admin` WHERE `user_type` = 'admin'");
