...
if (isset($_GET['id'])) {
    ...
    die("ID de licencia no proporcionado.");
}

$sql = "SELECT * FROM users WHERE id = '$license_id'";
$result = $conn->query($sql);
$result = $result->fetch_object();
if (!$result) {
    die("No se encontró la licencia con el ID proporcionado.");
}
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Modificar licencia!</h3>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="update">
                                    <div class="form-body">
                                        <input type="text" style="display:none;" id="idl" name="idl" value="<?php echo $result->id; ?>">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                    <label class="form-label">Ingrese el Número de Whatsapp (Con Código de País)</label>
                                                    <input type="number" class="form-control" id="wnumber" name="wnumber" value="<?php echo $result->whatsapp_number; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="cname" name="cname" value="<?php echo $result->customer_name; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="end-date" name="end-date" value="<?php echo date('Y-m-d', strtotime($result->end_date)); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                    <label class="form-label">Licencia Generada</label>
                                                    <input type="text" class="form-control" value="<?php echo $result->license_key; ?>" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-actions">
                                        <div class="text-end">
                                            <button type="button" id="generate-license" class="btn btn-info">Actualizar</button>
                                        </div>
                                    </div>
                                </form>
    ...
    <script>
        $(document).ready(function() {
            $('#generate-license').click(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'function/update-license.php', // Reemplazar con la ruta correcta a tu script PHP
                    data: {
                        idl:idl,
                        wnumber: wnumber,
                        validity: validity,
